  ...
  const fetchWhatsAppMessages = async () => {
    ...
    try {
      const response = await fetch(
        `/api/whatsapp/messages?phone=${encodeURIComponent(tenant.phone)}`,
      );
      const data = await response.json();
      ...
      <SidebarLayout sidebar={<SidebarContent currentPath="/residents" />}>
        <div className="space-y-6">
          <div className="flex items-center text-sm text-gray-500">
            ...
            <Link href="/residents" className="hover:text-gray-700">
              Residents
            </Link>
            <span className="mx-2">/</span>
          ...
          <div className="text-center py-12">
            ...
            <p className="mt-1 text-sm text-gray-500">
              The resident you're looking for doesn't exist or has been removed.
            </p>
          </div>
        </div>
      </SidebarLayout>
  ...
  return (
    <SidebarLayout sidebar={<SidebarContent currentPath="/residents" />}>
      <div className="space-y-6">
        ...
        {/* ResidentFormDrawer */}
        <ResidentFormDrawer isOpen={isEditDrawerOpen}
          onClose={() => setIsEditDrawerOpen(false)}
          onSubmit={handleSubmit}
          properties={[
            {
              id: tenant.lease?.property_uuid || "",
              ...
              <div className="space-y-4">
                ...
                {tenant.phone && (
                  <div className="rounded-md bg-gray-50 p-4">
                    <div className="flex">
                      <div className="flex-shrink-0">
                        <svg className="h-5 w-5 text-indigo-500"
                          viewBox="0 0 20 20"
                          fill="currentColor"
                        >
