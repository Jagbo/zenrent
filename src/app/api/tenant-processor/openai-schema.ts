...
export const tenantSchema = {
  ...
  properties: {
    ...
    paymentMethod: {
      type: "string",
      enum: ["bank-transfer", "standing-order", "direct-debit", "cash", "check"],
    ...
    depositScheme: {
      type: "string",
      enum: ["deposit-protection-service", "my-deposits", "tenancy-deposit-scheme", "other"],
...
export const standardPropertyFunction = {
  ...
  description: "Process and structure tenant data for a standard (non-HMO) property",
  parameters: {
    type: "object",
    properties: {
      propertyId: {
      ...
      tenancyDetails: {
        type: "object",
        description: "Common tenancy details that apply to all tenants in this property",
        properties: {
          agreementType: {
            type: "string",
            enum: ["ast", "non-ast", "company-let", "student", "other"],
        ...
        required: ["agreementType", "tenancyTerm", "startDate", "rentAmount", "rentFrequency", "rentDueDay"]
      },
      tenants: {
        type: "array",
        description: "Array of tenants for this property (typically 1-2 tenants for standard properties)",
        items: {
          type: "object",
          properties: {
            firstName: {
...
export const hmoPropertyFunction = {
  ...
  description: "Process and structure tenant data for an HMO property where each room has a separate tenant and potentially different tenancy details",
  parameters: {
    type: "object",
    properties: {
      propertyId: {
        type: "string",
        description: "The ID of the HMO property these tenants are associated with"
      },
      propertyAddress: {
        type: "string",
      ...
      rooms: {
        type: "array",
        description: "Array of rooms with tenant and tenancy details specific to each room",
        items: {
          type: "object",
          properties: {
            roomNumber: {
