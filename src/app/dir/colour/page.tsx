  ...
  const colorCategories: ColorCategory[] = [
    {
      ...
      description:
        "The main brand colors used throughout the application for primary elements.",
      colors: [
        {
          name: "Primary",
          variable: "--primary",
          ...
          description:
            "Main brand color used for primary buttons, key actions, and important UI elements.",
        },
        {
          ...
          description:
            "Text color used on primary-colored elements to ensure readability.",
        },
      ],
    },
    {
      ...
      colors: [
        {
          ...
          description:
            "Used for secondary buttons, less prominent actions, and background highlights.",
        },
        {
      ...
      colors: [
        {
          ...
          dark: "oklch(0.278 0.033 256.848)",
          description:
            "Used for hover states, highlighting active items, and decorative accents.",
        },
        {
      ...
      colors: [
        {
          ...
          description:
            "Used for delete buttons, error messages, and other destructive actions.",
        },
        {
    ...
    },
    {
      ...
      colors: [
        ...
        },
        {
          ...
          description:
            "Used for muted text like placeholders and secondary text.",
        },
      ],
    },
    {
      title: "Chart Colors",
      description:
        "Used for data visualization in charts and graphs. The primary palette consists of 5 colors, with additional chart colors mapped to this core set.",
      colors: [
        {
          name: "Chart 1",
          variable: "--chart-1",
          ...
          description:
            "Primary chart color, used for main data series. Also mapped to chart-6.",
        },
        {
          name: "Chart 2",
          variable: "--chart-2",
          ...
          description:
            "Secondary chart color, used for comparison data. Also mapped to chart-7.",
        },
        {
          name: "Chart 3",
          variable: "--chart-3",
        ...
        },
        {
          ...
          description:
            "Used for 4th data series in charts. Also mapped to chart-9.",
        },
        {
          name: "Chart 5",
          variable: "--chart-5",
          ...
          description:
            "Used for 5th data series in charts. Also mapped to chart-8.",
        },
        {
          name: "Chart 6",
          variable: "--chart-6",
    ...
    },
    {
      ...
      description:
        "Specific chart data series are mapped to the core chart color palette for consistent visualization across the application.",
      colors: [
        {
          name: "Income",
    ...
    <div className="p-8">
      ...
      <div className="mb-6">
        <p className="text-lg mb-4">
          ZenRent uses a consistent color system across the application to
          ensure a cohesive visual experience. Colors are defined using OKLCH
          color space for better perceptual uniformity and are designed to work
          ...
          <div key={index} className="space-y-4">
            ...
            <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
              {category.colors.map((color, colorIndex) => (
                <div key={colorIndex}
                  className={`border rounded-lg overflow-hidden ${color.mappedTo ? "opacity-70" : ""}`}
                >
        ...
        <div className="space-y-6">
          <div>
            ...
            <ul className="list-disc pl-6 space-y-2">
              ...
              <li>
                Secondary actions: Use secondary colors for less important
                actions
              </li>
              <li>
                Destructive actions: Use destructive colors for delete/remove
                actions
              </li>
              <li>
                Ghost/plain buttons: Use for tertiary actions without strong
                visual emphasis
              </li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="list-disc pl-6 space-y-2">
              ...
              <li>
                Cards and containers: Use card color for elevated surfaces
              </li>
              <li>
                Secondary containers: Use muted color for subtly differentiated
                areas
              </li>
              <li>
                Text hierarchy: Use foreground for primary text,
          ...
          <div>
            ...
            <ul className="list-disc pl-6 space-y-2">
              ...
              <li>
                Variables chart-6 through chart-9 map to the core palette
                (chart-1 through chart-5)
              </li>
              <li>
                Specific data series have dedicated color variables (e.g.,
                --color-income, --color-expenses)
              </li>
              <li>
                Maintain consistent semantic meaning of colors (e.g., income is
                always chart-1)
              </li>
              <li>
                Ensure sufficient contrast between adjacent chart elements
              </li>
            </ul>
          </div>
        </div>
