...
export const AccountingSoftwareDrawer: React.FC<AccountingSoftwareDrawerProps> = ({ 
  isOpen, 
  onClose 
}) => {
          ...
          <div className="space-y-4">
            ...
            <div className="p-4 rounded-lg border border-gray-200">
              <div className="flex items-center space-x-4">
                ...
                <div>
                  <p className="text-sm font-medium text-gray-900">Sign in to your {selectedProvider} account</p>
                  <p className="text-sm text-gray-500">Use your existing credentials to sign in</p>
                </div>
              </div>
            </div>
            ...
            <div className="p-4 rounded-lg border border-gray-200">
              <div className="flex items-center space-x-4">
                ...
                <div>
                  <p className="text-sm font-medium text-gray-900">Authorize ZenRent</p>
                  <p className="text-sm text-gray-500">Grant permission to access your financial data</p>
                </div>
              </div>
            </div>
            ...
            <div className="p-4 rounded-lg border border-gray-200">
              <div className="flex items-center space-x-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-500">Configure how data is synced between systems</p>
                </div>
              </div>
            </div>
          </div>
