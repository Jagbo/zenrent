...
const teams = [
  { id: 1, name: 'Manchester', href: '/teams/manchester', initial: 'M', current: false },
  { id: 2, name: 'London', href: '/teams/london', initial: 'L', current: false },
  { id: 3, name: 'Edinburgh', href: '/teams/edinburgh', initial: 'E', current: false },
]
                        ...
                        <li key={item.name}>
                          ...
                          >
                            <item.icon
                              aria-hidden="true"
                              className={classNames(
                                item.current ? 'text-chardonnay-600' : 'text-gray-400 group-hover:text-chardonnay-600',
                                'size-6 shrink-0',
                              )}
                            />
                            {item.name}
      ...
      <main className="py-10 lg:pl-72">
        <div className="px-4 sm:px-6 lg:px-8">
          <div className="bg-white rounded-lg shadow-sm p-6">
            ...
            <p className="text-gray-600">This is a sample dashboard with the chardonnay color scheme applied.</p>
            
            <div className="mt-8 grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3">
              {/* Sample cards */}
              <div className="bg-white border border-chardonnay-100 rounded-lg shadow-sm p-6">
                <h2 className="text-lg font-medium text-gray-900">Properties</h2>
                <p className="mt-2 text-3xl font-bold text-chardonnay-600">12</p>
              </div>
              
              <div className="bg-white border border-chardonnay-100 rounded-lg shadow-sm p-6">
                <h2 className="text-lg font-medium text-gray-900">Residents</h2>
                <p className="mt-2 text-3xl font-bold text-chardonnay-600">48</p>
              </div>
