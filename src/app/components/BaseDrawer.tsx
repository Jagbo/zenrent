...
export const BaseDrawer: React.FC<BaseDrawerProps> = ({ 
  ...
  const getBlurClass = () => {
    switch (blurIntensity) {
      ...
      case 'md': return 'backdrop-blur-md backdrop-filter';
      case 'lg': return 'backdrop-blur-lg backdrop-filter';
      default: return 'backdrop-blur-md backdrop-filter';
    }
  };
  ...
  return (
    <div className="fixed inset-0 overflow-hidden z-50">
      <div className="absolute inset-0 overflow-hidden">
        <div 
          className={`fixed inset-0 w-full h-full ${getOpacityClass()} ${getBlurClass()} transition-opacity z-40`} 
          onClick={onClose} 
          aria-hidden="true"
        />
