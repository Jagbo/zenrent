    ...
    <div className="flex flex-col h-full overflow-hidden border border-gray-200 rounded-lg bg-white">
      ...
      <div className="flex items-center p-4 border-b border-gray-200">
        <div className="flex items-center space-x-3">
          <Image
            src={tenantImage || getInitialsAvatar(tenantName)}
            alt={tenantName}
            width={40}
            height={40}
          ...
          />
          <div>
            <h3 className="text-base font-medium text-gray-900">{tenantName}</h3>
            ...
            >
              ...
              >
                ...
                <p className={`text-xs mt-1 ${
                  message.from === 'business' ? 'text-blue-100' : 'text-gray-500'
                }`}>
