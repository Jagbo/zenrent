...
import { BuildingOffice2Icon, UserIcon, DocumentIcon } from '@heroicons/react/24/outline'
...
export type SearchResult = SearchResultProperty | SearchResultResident | SearchResultPage

// Sample data - replace with actual data fetching logic
const sampleProperties: SearchResultProperty[] = [
  { id: '123-main', name: '123 Main Street', address: 'Manchester, M1 1AA', type: 'property' },
  { id: '456-park', name: '456 Park Avenue', address: 'Liverpool, L1 1AA', type: 'property' },
  { id: '789-ocean', name: '789 Ocean Drive', address: 'Brighton, BN1 1AA', type: 'property' },
  { id: '321-victoria', name: '321 Victoria Road', address: 'Edinburgh, EH1 1AA', type: 'property' },
  { id: '654-royal', name: '654 Royal Crescent', address: 'Bath, BA1 1AA', type: 'property' },
  { id: '987-kings', name: '987 Kings Road', address: 'London, SW3 1AA', type: 'property' },
]

const sampleResidents: SearchResultResident[] = [
  { id: '1', name: 'Leslie Abbott', property: '123 Main Street', unit: 'Room 101', type: 'resident' },
  { id: '2', name: 'Hector Adams', property: '123 Main Street', unit: 'Room 102', type: 'resident' },
  { id: '3', name: 'Blake Alexander', property: '123 Main Street', unit: 'Room 103', type: 'resident' },
  { id: '4', name: 'Molly Wilson', property: '456 Park Avenue', unit: 'Room 101', type: 'resident' },
  { id: '5', name: 'John Smith', property: '456 Park Avenue', unit: 'Room 102', type: 'resident' },
  { id: '6', name: 'Emma Thompson', property: '789 Ocean Drive', unit: 'Room 101', type: 'resident' },
]
...
export function SearchAutocomplete({
  ...
  useEffect(() => {
    ...
    const filteredProperties = sampleProperties.filter(
      property => property.name.toLowerCase().includes(query) || property.address.toLowerCase().includes(query)
    )
    ...
    // Filter pages
    const filteredPages = samplePages.filter(
      page => page.name.toLowerCase().includes(query)
    )
    
    // Combine results
    const allResults = [...filteredProperties, ...filteredResidents, ...filteredPages]
                ...
                >
                  <div className="flex items-center">
                    ...
                    <div>
                      ...
                      {result.type === 'resident' && (
                        <p className="text-xs text-gray-500">{result.property} - {result.unit}</p>
                      )}
                      {result.type === 'page' && (
