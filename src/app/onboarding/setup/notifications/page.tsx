        ...
        <div className="grid grid-cols-1 gap-x-8 gap-y-8 py-8 md:grid-cols-3">
          <div className="px-4 sm:px-0">
            ...
            <p className="mt-1 text-sm/6 text-gray-600">
              Customize how and when you receive alerts about important property
              management events.
            </p>
              ...
              <div className="grid max-w-2xl grid-cols-1 gap-x-6 gap-y-8">
                ...
                <div className="border-b border-gray-900/10 pb-6">
                  ...
                  <div className="space-y-4">
                    <div className="flex items-center justify-between">
                      <label htmlFor="email-rent-payments"
                        className="text-sm font-medium text-gray-900"
                      >
                        Rent payment alerts
                      </label>
                      <ToggleSwitch enabled={emailRentPayments}
                        onChange={() =>
                          setEmailRentPayments(!emailRentPayments)
                        }
                      />
                    </div>

                    <div className="flex items-center justify-between">
                      <label htmlFor="email-rent-arrears"
                        className="text-sm font-medium text-gray-900"
                      >
                        Rent arrears alerts
                      </label>
                      <ToggleSwitch enabled={emailRentArrears}
                        onChange={() => setEmailRentArrears(!emailRentArrears)}
                      />
                    </div>
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <ToggleSwitch enabled={emailMaintenance}
                        onChange={() => setEmailMaintenance(!emailMaintenance)}
                      />
                    </div>

                    <div className="flex items-center justify-between">
                      <label htmlFor="email-documents"
                        className="text-sm font-medium text-gray-900"
                      >
                        Document updates
                      </label>
                      <ToggleSwitch enabled={emailDocuments}
                        onChange={() => setEmailDocuments(!emailDocuments)}
                      />
                    </div>

                    <div className="flex items-center justify-between">
                      <label htmlFor="email-compliance"
                        className="text-sm font-medium text-gray-900"
                      >
                        Compliance reminders
                      </label>
                      <ToggleSwitch enabled={emailCompliance}
                        onChange={() => setEmailCompliance(!emailCompliance)}
                      />
                    </div>

                    <div className="flex items-center justify-between">
                      <label htmlFor="email-tenancy-expiry"
                        className="text-sm font-medium text-gray-900"
                      >
                        Tenancy expiry reminders
                      </label>
                      <ToggleSwitch enabled={emailTenancyExpiry}
                        onChange={() =>
                          setEmailTenancyExpiry(!emailTenancyExpiry)
                        }
                      />
                    </div>

                    <div className="flex items-center justify-between">
                      <label htmlFor="email-financial-summaries"
                        className="text-sm font-medium text-gray-900"
                      >
                        Financial reports and summaries
                      </label>
                      <ToggleSwitch enabled={emailFinancialSummaries}
                        onChange={() =>
                          setEmailFinancialSummaries(!emailFinancialSummaries)
                        }
                      />
                    </div>
                  </div>
                ...
                <div className="border-b border-gray-900/10 pb-6">
                  ...
                  <p className="mt-1 text-sm/6 text-gray-600 mb-4">
                    ...
                    These are typically reserved for high-priority or urgent
                    matters.
                  </p>

                  <div className="space-y-4">
                    <div className="flex items-center justify-between">
                      <label htmlFor="sms-urgent-maintenance"
                        className="text-sm font-medium text-gray-900"
                      >
                        Urgent maintenance issues
                      </label>
                      <ToggleSwitch enabled={smsUrgentMaintenance}
                        onChange={() =>
                          setSmsUrgentMaintenance(!smsUrgentMaintenance)
                        }
                      />
                    </div>

                    <div className="flex items-center justify-between">
                      <label htmlFor="sms-rent-payments"
                        className="text-sm font-medium text-gray-900"
                      >
                        Rent payment confirmations
                      </label>
                      <ToggleSwitch enabled={smsRentPayments}
                        onChange={() => setSmsRentPayments(!smsRentPayments)}
                      />
                    </div>

                    <div className="flex items-center justify-between">
                      <label htmlFor="sms-tenant-communication"
                        className="text-sm font-medium text-gray-900"
                      >
                        Tenant communication alerts
                      </label>
                      <ToggleSwitch enabled={smsTenantCommunication}
                        onChange={() =>
                          setSmsTenantCommunication(!smsTenantCommunication)
                        }
                      />
                    </div>
                  </div>
                ...
                <div>
                  ...
                  <div className="space-y-4">
                    <div className="flex items-center justify-between">
                      ...
                      <ToggleSwitch enabled={appNotifications}
