...
export default function PropertySpreadsheetImport() {
  ...
  const processPropertyData = async (propertyData: any[]) => {
    try {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setUploadError(error instanceof Error ? error.message : 'There was an error processing your property data. Please check your file format and try again.');
      setUploading(false);
      setProcessing(false);
    }
  };
      ...
      <div className="divide-y divide-gray-900/10">
        ...
        <div className="grid grid-cols-1 gap-x-8 gap-y-8 py-8 md:grid-cols-3">
          <div className="px-4 sm:px-0">
            <h2 className="text-base/7 font-semibold text-gray-900">Import Properties</h2>
          ...
          <div className="bg-white border border-gray-300 ring-1 shadow-xs ring-gray-900/5 sm:rounded-xl md:col-span-2">
            <div className="px-4 py-4 sm:p-6">
              <div className="grid max-w-2xl grid-cols-1 gap-x-6 gap-y-8">
                ...
                <div className="border-b border-gray-900/10 pb-6">
                  ...
                  <p className="mt-1 text-sm/6 text-gray-600">
                    Start by downloading our template file to ensure your property data is formatted correctly.
                  </p>
                        ...
                        {uploadSuccess && (
                          <div className="mt-4">
                            <div className="flex items-center justify-center gap-x-2 text-sm text-green-600">
                              ...
                              <span>Upload successful! Redirecting to tenant setup...</span>
                            </div>
                          </div>
                        )}
                      </div>
                ...
                <div className="border-b border-gray-900/10 pb-6">
                  ...
                  <div className="mt-2 text-sm text-gray-600">
                    ...
                    <ul className="mt-2 list-disc pl-5 space-y-1">
                      ...
                      <li>For addresses, include the full address with postcode</li>
                      <li>For property types, use: house, apartment, studio, hmo, or commercial</li>
                      <li>For the "Is HMO" field, use "true" or "false" (without quotes)</li>
                      <li>For dates, use DD/MM/YYYY format</li>
                      <li>For currency values, don't include currency symbols (£)</li>
                      <li>Each row in the spreadsheet represents one property</li>
                    </ul>
                  </div>
                </div>
            ...
            <div className="flex items-center justify-end gap-x-6 border-t border-gray-900/10 px-4 py-4 sm:px-6">
              <button
                type="button"
                onClick={() => router.push('/onboarding/property/import-options')}
