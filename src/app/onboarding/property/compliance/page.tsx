      ...
      <div className="divide-y divide-gray-900/10">
        ...
        <div className="grid grid-cols-1 gap-x-8 gap-y-8 py-8 md:grid-cols-3">
          <div className="px-4 sm:px-0">
            <h2 className="text-base/7 font-semibold text-gray-900">Property Compliance</h2>
              ...
              <div className="grid max-w-2xl grid-cols-1 gap-x-6 gap-y-8">
                ...
                <div className="border-b border-gray-900/10 pb-6">
                  <div className="flex items-start">
                    ...
                    <div className="ml-3 text-sm leading-6">
                      <label htmlFor="gasChecked" className="font-medium text-gray-900">
                        Gas Safety Certificate
                      </label>
                      <p className="text-gray-500">Required annually for properties with gas appliances.</p>
                    </div>
                  </div>
                  ...
                  {formData.gasChecked && (
                    <div className="mt-4 grid grid-cols-1 gap-x-6 gap-y-4 sm:grid-cols-6">
                      <div className="sm:col-span-3">
                        <label htmlFor="gasDate" className="block text-sm font-medium leading-6 text-gray-900">
                          Issue date
                        </label>
                        <div className="mt-2">
                          <input
                      ...
                      <div className="sm:col-span-3">
                        <label htmlFor="gasExpiry" className="block text-sm font-medium leading-6 text-gray-900">
                          Expiry date
                        </label>
                        <div className="mt-2">
                          <input
                ...
                <div className="border-b border-gray-900/10 pb-6">
                  <div className="flex items-start">
                    ...
                    <div className="ml-3 text-sm leading-6">
                      <label htmlFor="electricalChecked" className="font-medium text-gray-900">
                        Electrical Installation Condition Report (EICR)
                      </label>
                      <p className="text-gray-500">Required every 5 years for rental properties.</p>
                    </div>
                  </div>
                  ...
                  {formData.electricalChecked && (
                    <div className="mt-4 grid grid-cols-1 gap-x-6 gap-y-4 sm:grid-cols-6">
                      <div className="sm:col-span-3">
                        <label htmlFor="electricalDate" className="block text-sm font-medium leading-6 text-gray-900">
                          Issue date
                        </label>
                        <div className="mt-2">
                          <input
                      ...
                      <div className="sm:col-span-3">
                        <label htmlFor="electricalExpiry" className="block text-sm font-medium leading-6 text-gray-900">
                          Expiry date
                        </label>
                        <div className="mt-2">
                          <input
                ...
                <div className="border-b border-gray-900/10 pb-6">
                  <div className="flex items-start">
                    ...
                    <div className="ml-3 text-sm leading-6">
                      <label htmlFor="epcChecked" className="font-medium text-gray-900">
                        Energy Performance Certificate (EPC)
                      </label>
                      <p className="text-gray-500">Required every 10 years for rental properties.</p>
                    </div>
                  </div>
                  ...
                  {formData.epcChecked && (
                    <div className="mt-4 grid grid-cols-1 gap-x-6 gap-y-4 sm:grid-cols-6">
                      <div className="sm:col-span-3">
                        <label htmlFor="epcDate" className="block text-sm font-medium leading-6 text-gray-900">
                          Issue date
                        </label>
                        <div className="mt-2">
                          <input
                      ...
                      <div className="sm:col-span-3">
                        <label htmlFor="epcExpiry" className="block text-sm font-medium leading-6 text-gray-900">
                          Expiry date
                        </label>
                        <div className="mt-2">
                          <input
