...
export default function PropertyMedia() {
  ...
  const handlePhotoUpload = (e: React.ChangeEvent<HTMLInputElement>) => {
    if (e.target.files && e.target.files.length > 0) {
      ...
      const mainPhotoId =
        formData.mainPhotoId ||
        (updatedPhotos.length > 0 ? updatedPhotos[0].id : "");
            ...
            <div className="px-4 py-4 sm:p-6">
              <div className="grid max-w-2xl grid-cols-1 gap-x-6 gap-y-8">
                ...
                <div className="border-b border-gray-900/10 pb-6">
                  ...
                  <p className="mt-1 text-sm/6 text-gray-600">
                    Upload photos of your property. The first photo will be used
                    as the main photo.
                  </p>
                    ...
                    {formData.photos.length === 0 ? (
                      ...
                      <div>
                        ...
                        <p className="mt-2 text-xs text-gray-500">
                          Click on a photo and use the buttons to set as main
                          photo or remove.
                        </p>
                      </div>
                    )}
                ...
                <div className="border-b border-gray-900/10 pb-6">
                  ...
                  <div className="mt-4">
                    ...
                    {!formData.floorPlan ? (
                      <div onClick={triggerFloorPlanInput}
                        className="relative block w-full rounded-lg border-2 border-dashed border-gray-300 p-12 text-center hover:border-gray-400 focus:outline-none focus:ring-2 focus:ring-d9e8ff-80 focus:ring-offset-2 cursor-pointer"
                      >
                      ...
                      <div className="relative rounded-lg border border-gray-300 overflow-hidden">
                        {formData.floorPlanPreview && (
                          <Image src={formData.floorPlanPreview}
                            alt="Floor Plan"
                        ...
                        <div className="p-2 bg-gray-50 border-t border-gray-300">
                          ...
                          <p className="text-xs text-gray-500">
                            {(formData.floorPlan?.size &&
                              (formData.floorPlan.size / 1024 / 1024).toFixed(
                                2,
                              )) ||
                              0}{" "}
                            MB
                ...
                <div>
                  ...
                  <p className="mt-1 text-sm/6 text-gray-600">
                    Add a link to a video of your property (YouTube, Vimeo,
                    etc.).
                  </p>
