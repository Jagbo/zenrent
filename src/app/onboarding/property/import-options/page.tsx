...
const importOptions = [
  {
    ...
    description:
      "Enter property details one by one through our guided form process.",
    icon: PlusCircleIcon,
    benefits: [
...
export default function PropertyImportOptions() {
  ...
  const handleContinue = async () => {
    ...
    try {
      ...
      if (profileError) {
        throw new Error(
          `Failed to save import preference: ${profileError.message}`,
        );
      }
            ...
            <div className="px-4 py-4 sm:p-6">
              <div className="grid max-w-2xl grid-cols-1 gap-x-6 gap-y-8">
                ...
                <div className="border-b border-gray-900/10 pb-6">
                  ...
                  <p className="mt-1 text-sm/6 text-gray-600">
                    Choose the method that best suits your needs for adding
                    properties.
                  </p>
                        ...
                        <div className="flex-1">
                          ...
                          <ul className="mt-2 space-y-1">
                            {option.benefits.map((benefit, index) => (
                              ...
                              >
                                <CheckIcon className="mr-2 size-4 text-gray-900"
                                  aria-hidden="true"
                                />
                                {benefit}
                              </li>
                ...
                <div className="border-b border-gray-900/10 pb-6">
                  ...
                  <div className="mt-2 text-sm text-gray-600">
                    ...
                    <ul className="mt-2 list-disc pl-5 space-y-1">
                      ...
                      <li>
                        Have property compliance documents ready to upload
                      </li>
                      <li>
                        Prepare financial details such as mortgage information
                        and rental income
                      </li>
                    </ul>
                  </div>
                ...
                <div>
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      <h3 className="text-sm title-font text-gray-900">
                        Data Protection Notice
                      </h3>
