        ...
        <div className="grid grid-cols-1 gap-x-8 gap-y-8 py-8 md:grid-cols-3">
          <div className="px-4 sm:px-0">
            ...
            <p className="mt-1 text-sm/6 text-gray-600">
              Enter the financial information related to your property to help
              us set up income tracking and expense management.
            </p>
          </div>
            ...
            <div className="px-4 py-4 sm:p-6">
              <div className="grid max-w-2xl grid-cols-1 gap-x-6 gap-y-8">
                ...
                <div className="border-b border-gray-900/10 pb-6">
                  ...
                  <p className="mt-1 text-sm/6 text-gray-600">
                    Information about the rental terms and deposit for this
                    property.
                  </p>
                ...
                <div className="border-b border-gray-900/10 pb-6">
                  ...
                  <div className="mt-4 grid grid-cols-1 gap-x-6 gap-y-4 sm:grid-cols-6">
                    ...
                    <div className="sm:col-span-3">
                      <label htmlFor="fixedTermEndDate"
                        className="block text-sm font-medium leading-6 text-gray-900"
                      >
                        Fixed term end date
                      </label>
                ...
                <div className="border-b border-gray-900/10 pb-6">
                  ...
                  <p className="mt-1 text-sm/6 text-gray-600">
                    Details about your landlord insurance policy for this
                    property.
                  </p>
                  ...
                  <div className="mt-4 grid grid-cols-1 gap-x-6 gap-y-4 sm:grid-cols-6">
                    <div className="sm:col-span-3">
                      ...
                      <p className="mt-1 text-xs text-gray-500">
                        Include utility bills, service charges, ground rent,
                        etc.
                      </p>
                    </div>
                    ...
                    <div className="sm:col-span-3">
                      ...
                      <p className="mt-1 text-xs text-gray-500">
                        If you use a property management service, enter the
                        monthly fee.
                      </p>
                    </div>
                  </div>
