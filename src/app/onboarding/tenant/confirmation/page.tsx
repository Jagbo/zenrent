  ...
  useEffect(() => {
    try {
      ...
      if (currentProperty && currentProperty.address) {
        const index = existingProperties.findIndex(
          (prop: unknown) => prop.address === currentProperty.address,
        );
        console.log(
          "Found property at index:",
          index,
          "with address:",
                  ...
                  <>
                    ...
                    <div className="pt-6">
                      ...
                      <div className="mt-3 space-y-4">
                        {tenancyData.tenants.map(
                          (tenant: unknown, index: number) => (
                            <div key={index}
                      ...
                      <div className="mt-3 grid grid-cols-1 gap-x-6 gap-y-2 sm:grid-cols-6">
                        <div className="sm:col-span-6">
                          <p className="text-sm font-medium text-gray-900">
                            {tenancyData.property.address}
                          </p>
                          <p className="text-sm text-gray-500">
                            {tenancyData.property.propertyType} •{" "}
                            {tenancyData.property.bedrooms}{" "}
                            {parseInt(tenancyData.property.bedrooms) > 1
                              ? "Bedrooms"
                              : "Bedroom"}
                          </p>
                        </div>
                    ...
                    <div className="border-b border-gray-900/10 py-6">
                      ...
                      <div className="mt-3 grid grid-cols-1 gap-x-6 gap-y-2 sm:grid-cols-6">
                        <div className="sm:col-span-3">
                          ...
                          <dd className="mt-1 text-sm text-gray-900">
                            {tenancyData.tenancy.agreementType}
                          </dd>
                        </div>
                        <div className="sm:col-span-3">
                          <dt className="text-sm font-medium text-gray-500">
                          ...
                          <dd className="mt-1 text-sm text-gray-900">
                            {tenancyData.tenancy.tenancyTerm}
                          </dd>
                        </div>
                        <div className="sm:col-span-3">
                          <dt className="text-sm font-medium text-gray-500">
                          ...
                          <dd className="mt-1 text-sm text-gray-900">
                            {formatDate(tenancyData.tenancy.startDate)}
                          </dd>
                        </div>
                        {tenancyData.tenancy.endDate && (
                          <div className="sm:col-span-3">
                            ...
                            <dd className="mt-1 text-sm text-gray-900">
                              {formatDate(tenancyData.tenancy.endDate)}
                            </dd>
                          </div>
                        )}
                        {tenancyData.tenancy.hasBreakClause &&
                          tenancyData.tenancy.breakClauseDetails && (
                            <div className="sm:col-span-6">
                              <dt className="text-sm font-medium text-gray-500">
                                Break Clause
                              </dt>
                    ...
                    <div className="border-b border-gray-900/10 py-6">
                      ...
                      <div className="mt-3 grid grid-cols-1 gap-x-6 gap-y-2 sm:grid-cols-6">
                        <div className="sm:col-span-3">
                          ...
                          <dd className="mt-1 text-sm text-gray-900">
                            {formatCurrency(tenancyData.tenancy.rentAmount)}
                          </dd>
                        </div>
                        <div className="sm:col-span-3">
                          <dt className="text-sm font-medium text-gray-500">
                          ...
                          <dd className="mt-1 text-sm text-gray-900">
                            {tenancyData.tenancy.rentFrequency}
                          </dd>
                        </div>
                        <div className="sm:col-span-3">
                          <dt className="text-sm font-medium text-gray-500">
                          ...
                          <dd className="mt-1 text-sm text-gray-900">
                            {tenancyData.tenancy.rentDueDay}
                          </dd>
                        </div>
                    ...
                    <div className="border-b border-gray-900/10 py-6">
                      ...
                      <div className="mt-3 grid grid-cols-1 gap-x-6 gap-y-2 sm:grid-cols-6">
                        <div className="sm:col-span-3">
                          ...
                          <dd className="mt-1 text-sm text-gray-900">
                            {formatCurrency(tenancyData.tenancy.depositAmount)}
                          </dd>
                        </div>
              ...
              <div className="px-4 py-6 sm:p-8">
                <div className="flex flex-col items-center justify-center py-8">
                  ...
                  <p className="mt-2 text-center text-sm text-gray-600">
                    You have successfully set up your tenant information. You
