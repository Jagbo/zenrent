      ...
      <div className="divide-y divide-gray-900/10">
        ...
        <div className="grid grid-cols-1 gap-x-8 gap-y-8 py-8 md:grid-cols-3">
          <div className="px-4 sm:px-0">
            <h2 className="text-base/7 font-semibold text-gray-900">Tenant Confirmation</h2>
            ...
            {tenancyData ? (
              ...
              <div className="px-4 py-6 sm:p-8">
                <div className="flex flex-col items-center justify-center py-8">
                  ...
                  <h2 className="mt-4 text-xl font-semibold text-gray-900">Tenant Setup Complete</h2>
