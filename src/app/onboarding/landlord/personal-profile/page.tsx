...
const steps = [
  ...
  },
  {
    id: "02",
    name: "Landlord",
    href: "/onboarding/landlord/personal-profile",
    status: "current",
  },
        ...
        <div className="grid grid-cols-1 gap-x-8 gap-y-8 py-8 md:grid-cols-3">
          <div className="px-4 sm:px-0">
            ...
            <p className="mt-1 text-sm/6 text-gray-600">
              Please provide your personal information to comply with UK
                ...
                <div className="border-b border-gray-900/10 pb-6">
                  ...
                  <div className="mt-4 flex items-center gap-x-6">
                    ...
                    <div>
                      ...
                      >
                        <PhotoIcon className="inline-block -ml-0.5 mr-1.5 size-5 text-gray-400"
                          aria-hidden="true"
                        />
                        Upload photo
                      </button>
                    ...
                    <div className="sm:col-span-6">
                      ...
                      <div className="mt-2 relative">
                        <div className="relative">
                          ...
                          />
                          <CalendarIcon className="pointer-events-none absolute right-3 top-1/2 -translate-y-1/2 size-5 text-gray-400"
                            aria-hidden="true"
                          />
                        </div>
                      </div>
