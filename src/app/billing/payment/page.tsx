      ...
      <div className="py-8">
        <div className="mx-auto max-w-4xl">
          ...
          <div className="flex items-center mb-8">
            ...
            <h1 className="text-2xl title-font text-gray-900">
          ...
          {paymentSuccess ? (
            <div className="bg-white border border-gray-300 shadow-sm rounded-lg p-8 text-center">
              ...
              <h2 className="mt-4 text-lg title-font text-gray-900">
                Payment Successful
              </h2>
              ...
              <div className="lg:col-span-2">
                <div className="bg-white border border-gray-300 shadow-sm rounded-lg divide-y divide-gray-200">
                  <div className="border-b border-gray-200 bg-gray-50 px-4 py-4 sm:px-6 rounded-t-lg">
                    <h2 className="text-lg title-font text-gray-900">
                      Order Summary
                    </h2>
                  </div>
                  <div className="p-6">
                  ...
                  <div className="p-6">
                    ...
                    <form onSubmit={handleSubmit}>
                      <div className="space-y-6">
                        {/* Card Information */}
                        <div>
                          <h3 className="text-sm title-font text-gray-900 mb-4">
                            Card Information
                          </h3>
                      ...
                      <div className="mt-8">
                        ...
                        <p className="mt-2 text-center text-xs text-gray-500">
                          By confirming your subscription, you allow ZenRent to
