  ...
  Cleaner: [
    {
      ...
      imageUrl:
        "https://images.unsplash.com/photo-1563453392212-326f5e854473?ixlib=rb-1.2.1&auto=format&fit=crop&w=1950&q=80",
    ...
    },
    {
      ...
      imageUrl:
        "https://images.unsplash.com/photo-1614064641938-3bbee52942c7?ixlib=rb-1.2.1&auto=format&fit=crop&w=1950&q=80",
  ...
  Handyman: [
    {
      ...
      name: "FixIt Handyman",
      imageUrl:
        "https://images.unsplash.com/photo-1529316365294-599e7f244f1c?ixlib=rb-1.2.1&auto=format&fit=crop&w=1950&q=80",
    ...
    },
    {
      ...
      name: "Home Solutions",
      imageUrl:
        "https://images.unsplash.com/photo-1581578731548-c64695cc6952?ixlib=rb-1.2.1&auto=format&fit=crop&w=1950&q=80",
  ...
  Plumbing: [
    {
      ...
      name: "ABC Plumbing",
      imageUrl:
        "https://images.unsplash.com/photo-1607472586893-edb57bdc0e39?ixlib=rb-1.2.1&auto=format&fit=crop&w=1950&q=80",
    ...
    },
    {
      ...
      imageUrl:
        "https://images.unsplash.com/photo-1621905251189-08b45d6a269e?ixlib=rb-1.2.1&auto=format&fit=crop&w=1950&q=80",
      contact: {
  ...
  Electrics: [
    {
      ...
      name: "City Electric",
      imageUrl:
        "https://images.unsplash.com/photo-1555963966-b7ae5252581a?ixlib=rb-1.2.1&auto=format&fit=crop&w=1950&q=80",
    ...
    },
    {
      ...
      imageUrl:
        "https://images.unsplash.com/photo-1620881058460-ede2eec3853c?ixlib=rb-1.2.1&auto=format&fit=crop&w=1950&q=80",
  ...
  Other: [
    {
      ...
      imageUrl:
        "https://images.unsplash.com/photo-1558904541-efa5a24b0dda?ixlib=rb-1.2.1&auto=format&fit=crop&w=1950&q=80",
      contact: {
    ...
    },
    {
      ...
      name: "Secure Locks",
      imageUrl:
        "https://images.unsplash.com/photo-1580428456283-5dc0a0fde2f8?ixlib=rb-1.2.1&auto=format&fit=crop&w=1950&q=80",
...
export default function Suppliers() {
  ...
  const getFilteredSuppliers = (): Supplier[] => {
    ...
    if (activeTab !== "all") {
      ...
      return categorySuppliers.filter(
        (supplier) =>
  ...
  return (
    <SidebarLayout sidebar={<SidebarContent currentPath="/suppliers" />}
        ...
        <div className="flex flex-col md:flex-row md:items-center md:justify-between">
          <div>
            ...
            <Text className="text-gray-500 mt-1">
              Manage your property maintenance and service providers.
            </Text>
          </div>
        </div>
        ...
        <div>
          ...
          <div className="grid grid-cols-1 sm:hidden">
            <select value={activeTab}
              onChange={(e) =>
                handleTabChange(e.target.value as "all" | SupplierCategory)
              }
          ...
          <div className="hidden sm:block">
            ...
            >
              {tabs.map((tab, tabIdx) => (
                <a key={tab.name}
                  onClick={() =>
                    handleTabChange(tab.value as "all" | SupplierCategory)
                  }
