...
export function ZenAgent() {
  const [messages, setMessages] = useState<Message[]>([
    {
      id: 1,
      content: "Hello! I'm your ZenRent assistant. I can help you with property management, financial advice, and legal guidance. How can I assist you today?",
      sender: "ai",
    }
  ])
        ...
        <ExpandableChatFooter>
          ...
          >
            ...
            <div className="flex items-center p-3 pt-0 justify-between">
              ...
              <Button type="submit" size="sm" className="ml-auto gap-1.5 bg-[#D9E8FF] text-black hover:bg-[#C8D7EE]">
                Send Message
