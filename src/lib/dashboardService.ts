...
const getDashboardClient = () => {
  ...
  const supabaseServiceKey =
    serverRuntimeConfig.SUPABASE_SERVICE_ROLE_KEY ||
  ...
  if (!supabaseServiceKey) {
    ...
    console.log(
      "Make sure SUPABASE_SERVICE_ROLE_KEY is defined in your .env.local file",
    );
    ...
    if (!supabaseAnonKey) {
      ...
      throw new Error(
        "No Supabase key available. Please check your environment variables.",
      );
    }
