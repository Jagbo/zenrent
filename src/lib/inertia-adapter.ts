...
export const Inertia = {
  ...
  visit: (url: string, options: unknown = {}) => {
  ...
  get: (url: string, data: unknown = {}, options: unknown = {}) => {
    const router = useRouter();
  ...
  post: (url: string, data: unknown = {}, options: unknown = {}) => {
    console.warn(
      "Inertia.post is not fully implemented in the adapter. Using GET instead.",
    );
    Inertia.get(url, data, options);
  },

  put: (url: string, data: unknown = {}, options: unknown = {}) => {
    console.warn(
      "Inertia.put is not fully implemented in the adapter. Using GET instead.",
    );
    Inertia.get(url, data, options);
  },
  ...
  patch: (url: string, data: unknown = {}, options: unknown = {}) => {
    console.warn(
      "Inertia.patch is not fully implemented in the adapter. Using GET instead.",
    );
    Inertia.get(url, data, options);
  },
  ...
  delete: (url: string, options: unknown = {}) => {
    console.warn(
      "Inertia.delete is not fully implemented in the adapter. Using GET instead.",
    );
...
export function useForm<TForm extends Record<string, any>>(
  ...
  return {
    data: initialValues,
    setData: (key: keyof TForm, value: unknown) => {
